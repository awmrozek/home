...
int main() 
{
   ...
   // Naive algorithm test begins
   xil_printf("Naive algorithm test:\n");
   ...
   XTmrCtr_Stop(&timer, 0);
   time_val = XTmrCtr_GetValue(&timer, 0);
   xil_printf("Time took: %d\n\n", time_val);
   // Naive algorithm test ends

   // --------------------------------------------------------------

   // Fast algorithm test begins
   xil_printf("Fast algorithm test:\n");
