...
CONFIG.USE_BOARD_FLOW {true} \
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_0_100M/slowest_sync_clk]
...
preplace netloc rst_clk_wiz_0_100M_bus_struct_reset 1 2 2 NJ 470 970
preplace netloc clk_wiz_0_locked 1 1 1 180
preplace netloc microblaze_0_Clk 1 1 4 180 400 520 330 970 320 1290
...
preplace netloc rst_clk_wiz_0_100M_peripheral_aresetn 1 2 3 NJ 310 980 310 1300
preplace netloc reset_1 1 0 2 20 470 NJ
levelinfo -pg 1 0 100 340 740 1130 1410 1540 -top 0 -bot 590
",
}
